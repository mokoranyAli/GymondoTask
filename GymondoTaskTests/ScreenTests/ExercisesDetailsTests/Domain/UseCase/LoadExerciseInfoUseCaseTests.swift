//
//  LoadExerciseInfoUseCaseTests.swift
//  GymondoTaskTests
//
...
class LoadExerciseInfoUseCaseTests: XCTestCase {
    
    private var sut: LoadExerciseInfoUseCase!
    private var cancellables = Set<AnyCancellable>()
    
    override func setUp() {
        super.setUp()
        sut = .init(repository: MockSuccessExerciseInfoRepository())
    }
